...
def share_profile(profile_name: str, target_email: str) -> dict[str, Any]:
    ...
    message["Subject"] = f"RentRank Profile Settings: {profile_name}"
    message.set_content(
        "Hello! \n\n"

        f"This is an automated RentRank profile settings share generated by an owner of the following profile: {profile_name}\n\n"
        ...
        f"rentrank-nyc auth --profile-name {profile_name}\n to begin searches using these profile setings"
    )
